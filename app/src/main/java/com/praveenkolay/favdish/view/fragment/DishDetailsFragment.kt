...
import com.praveenkolay.favdish.databinding.FragmentDishDetailsBinding
...
class DishDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        args.let {
            ...
            mBinding!!.tvType.text = it.dishDetails.type.capitalize(Locale.ROOT) // Used to make the first letter capital
            mBinding!!.tvCategory.text = it.dishDetails.category
            mBinding!!.tvIngredients.text = it.dishDetails.ingredients
            mBinding!!.tvCookingDirection.text = it.dishDetails.cookingDirection
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                mBinding!!.tvCookingDirection.text = Html.fromHtml(
                        it.dishDetails.cookingDirection,
                        Html.FROM_HTML_MODE_COMPACT
                )
            }else{
                @Suppress("DEPRECATION")
                mBinding!!.tvCookingDirection.text = Html.fromHtml(it.dishDetails.cookingDirection)
            }

            mBinding!!.tvCookingTime.text = resources.getString(R.string.lbl_estimated_cooking_time, it.dishDetails.cookingTime)
