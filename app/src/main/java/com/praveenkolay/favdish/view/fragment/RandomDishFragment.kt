...
import com.praveenkolay.favdish.databinding.FragmentRandomDishesBinding
...
import com.praveenkolay.favdish.viewModel.RandomDishViewModel
...
class RandomDishFragment : Fragment() {
        ...
        mRandomDishViewModel.randomDishResponse.observe(viewLifecycleOwner,
            { randomDishResponse ->
                randomDishResponse?.let {
                    Log.d("Random Dish Response", "${randomDishResponse.recipes[0]}")
    ...
    private fun setRandomDishResponseInUI(recipe: RandomDish.Recipe){
        ...
        mBinding!!.tvCookingTime.text = resources.getString(
                R.string.lbl_estimated_cooking_time,
